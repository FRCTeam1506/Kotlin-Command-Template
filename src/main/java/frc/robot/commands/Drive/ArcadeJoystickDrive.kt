...
class ArcadeJoystickDrive : Command() {
    ...
    override fun execute(): Boolean
    {
        ...
        var yDirection: Double = OI().joystickLeft.y
        var xDirection: Double = OI().joystickLeft.x
        var spin: Double = OI().joystickLeft.twist
        var throttle: Double = ((OI().joystickLeft.throttle * -1) + 1) / 2
