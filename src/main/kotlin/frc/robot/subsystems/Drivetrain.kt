...
object Drivetrain : Subsystem(), PIDOutput {
    ...
    fun drive(yVal: Double, xVal: Double, spinVal: Double, throttleVal: Double) {
        ...
        if (localFieldOriented) {
            var angle: Double = navx.angle * Math.PI / 180
    ...
    fun fieldOrientedDrive(yVal: Double, xVal: Double, spinVal: Double, throttleVal: Double) {
        val angle: Double = navx.angle * Math.PI / 180
    ...
    */
    ...
    fun fieldOrientedDriveAtAngle(yVal: Double, xVal: Double, angle: Double, throttleVal: Double) {
		val gyroAngle: Double = navx.angle * Math.PI / 180 //convert degrees to radians
    ...
    fun getFieldOriented(): Boolean = isFieldOriented
    ...
    fun getDriftMode(): Boolean = isDriftMode
    ...
    fun lockAtAngle(targetPos: Double): Boolean
    {
        if (!isAngleLocked) {
            ...
            turnController.enable()
            turnController.setpoint = driveAngle
            isAngleLocked = true
        }
    ...
    fun deadReckon()//when run in a loop. keeps track of robot posistion through encoder values gives robot speed in meters per second
    {
    ...
    fun getAngle(): Double { return navx.angle * Math.PI / 180; }
    fun getEncoderRawFrontLeft(): Int = driveFrontLeft.getSelectedSensorPosition(0)
    fun getEncoderRawFrontRight(): Int = driveFrontRight.getSelectedSensorPosition(0)
    fun getEncoderRawBackLeft(): Int = driveBackLeft.getSelectedSensorPosition(0)
    fun getEncoderRawBackRight(): Int = driveBackRight.getSelectedSensorPosition(0)
    fun getEncoderVelocityFrontLeft(): Int = driveFrontLeft.getSelectedSensorVelocity(0)
    fun getEncoderVelocityFrontRight(): Int = driveFrontRight.getSelectedSensorVelocity(0)
    fun getEncoderVelocityBackLeft(): Int = driveBackLeft.getSelectedSensorVelocity(0)
    fun getEncoderVelocityBackRight(): Int = driveBackRight.getSelectedSensorVelocity(0)
    ...
    fun getSpeedFrontLeft(): Double = driveFrontLeft.get()
    fun getSpeedFrontRight(): Double = driveFrontRight.get()
    fun getSpeedBackLeft(): Double = driveBackLeft.get()
    fun getSpeedBackRight(): Double = driveBackRight.get()
